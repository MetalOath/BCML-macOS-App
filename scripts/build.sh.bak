...
cp -R "${ROOT_DIR}/bcml/"* "${BUILD_DIR}/${APP_NAME}/Contents/Resources/bcml/"
...
if [ -d "${ROOT_DIR}/venv" ]; then
  ...
  cp -R "${ROOT_DIR}/venv/lib/python"*"/site-packages/"* "${BUILD_DIR}/${APP_NAME}/Contents/Resources/lib/"
